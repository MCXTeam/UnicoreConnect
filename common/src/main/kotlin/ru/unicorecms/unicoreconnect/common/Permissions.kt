...
object Permissions {
    ...
    const val REAL = "unicoreconnect.command.real"
    ...
    val everyone = listOf(MONEY, MONEY_TOP, MONEY_PAY, REAL, PLAYTIME, PLAYTIME_TOP, SHOWCASE_LIST, SHOWCASE_GIVE, SHOWCASE_ALL)
