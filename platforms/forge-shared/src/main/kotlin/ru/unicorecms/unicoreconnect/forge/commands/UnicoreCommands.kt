package ru.unicorecms.unicoreconnect.forge.commands
...
import ru.unicorecms.unicoreconnect.forge.ForgePlayer

object UnicoreCommands {
    fun register(dispatcher: CommandDispatcher<CommandSourceStack>, platform: ForgePlatformImpl) {
    ...
    private fun registerMoney(dispatcher: CommandDispatcher<CommandSourceStack>, platform: ForgePlatformImpl) {
        dispatcher.register(
    ...
    private fun registerPlaytime(dispatcher: CommandDispatcher<CommandSourceStack>, platform: ForgePlatformImpl) {
        dispatcher.register(
    ...
    private fun registerShowcase(dispatcher: CommandDispatcher<CommandSourceStack>, platform: ForgePlatformImpl) {
        dispatcher.register(
    ...
    private fun registerAdmin(dispatcher: CommandDispatcher<CommandSourceStack>, platform: ForgePlatformImpl) {
        dispatcher.register(
    ...
    private fun listWarehouse(source: CommandSourceStack, platform: ForgePlatformImpl): Int {
    ...
    private fun giveWarehouse(source: CommandSourceStack, platform: ForgePlatformImpl, id: Int?): Int {
        val player = playerOf(source, platform) ?: return 0
    ...
    private fun playerOf(source: CommandSourceStack, platform: ForgePlatformImpl): ForgePlayer? {
        ...
        return ForgePlayer(handle)
    }

    private fun permitted(source: CommandSourceStack, platform: ForgePlatformImpl, node: String): Boolean {
